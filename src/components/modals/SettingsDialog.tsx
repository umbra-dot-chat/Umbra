...
const ACCENT_PRESETS: Array<{ color: string; name: string }> = [
  // ── Slate Blue finalist ──
  { color: '#5A6E8A', name: 'Slate Blue' },
  // ── Blues ──
  { color: '#3B82F6', name: 'Blue' },
  { color: '#2563EB', name: 'Royal Blue' },
  { color: '#1D4ED8', name: 'Sapphire' },
  { color: '#6B8FAD', name: 'Steel Blue' },
  { color: '#4A7C9B', name: 'Wedgewood' },
  { color: '#3A6B8A', name: 'Denim' },
  { color: '#7B98B8', name: 'Dusty Blue' },
  { color: '#4B6587', name: 'Cadet' },
  { color: '#2D4A6F', name: 'Navy Mist' },
  { color: '#5B7FA3', name: 'Cornflower' },
  // ── Indigos & Violets ──
  { color: '#6366F1', name: 'Indigo' },
  { color: '#8B5CF6', name: 'Violet' },
  { color: '#7C3AED', name: 'Purple' },
  { color: '#5B21B6', name: 'Deep Purple' },
  { color: '#7B7BAE', name: 'Soft Indigo' },
  { color: '#6B6B9E', name: 'Wisteria' },
  { color: '#9080A8', name: 'Muted Violet' },
  { color: '#8B6B8E', name: 'Plum' },
  { color: '#6A5A8E', name: 'Amethyst' },
  { color: '#7E6B9E', name: 'Lavender Gray' },
  // ── Pinks & Roses ──
  { color: '#EC4899', name: 'Pink' },
  { color: '#F43F5E', name: 'Rose' },
  { color: '#DB2777', name: 'Magenta' },
  { color: '#A07878', name: 'Dusty Rose' },
  { color: '#C49898', name: 'Blush' },
  { color: '#B08080', name: 'Mauve' },
  { color: '#9B6B7A', name: 'Antique Rose' },
  { color: '#A87080', name: 'Raspberry Dust' },
  { color: '#8B6878', name: 'Mulberry' },
  { color: '#C4889E', name: 'Orchid' },
  // ── Reds ──
  { color: '#EF4444', name: 'Red' },
  { color: '#DC2626', name: 'Crimson' },
  { color: '#B91C1C', name: 'Maroon' },
  { color: '#9B4444', name: 'Muted Red' },
  { color: '#A85454', name: 'Brick' },
  { color: '#8B4040', name: 'Barn Red' },
  // ── Oranges & Ambers ──
  { color: '#F97316', name: 'Orange' },
  { color: '#EA580C', name: 'Tangerine' },
  { color: '#C4886B', name: 'Terracotta' },
  { color: '#B07B5E', name: 'Burnt Sienna' },
  { color: '#B8886B', name: 'Copper' },
  { color: '#C8A060', name: 'Muted Amber' },
  { color: '#A8885B', name: 'Bronze' },
  { color: '#9B7B5B', name: 'Caramel' },
  { color: '#B5A06B', name: 'Antique Gold' },
  { color: '#C4A888', name: 'Desert Sand' },
  // ── Yellows ──
  { color: '#EAB308', name: 'Yellow' },
  { color: '#CA8A04', name: 'Goldenrod' },
  { color: '#A68B3B', name: 'Old Gold' },
  { color: '#8B8040', name: 'Olive Gold' },
  { color: '#B8A848', name: 'Saffron' },
  // ── Greens ──
  { color: '#22C55E', name: 'Green' },
  { color: '#16A34A', name: 'Emerald' },
  { color: '#15803D', name: 'Forest' },
  { color: '#6B8A6B', name: 'Sage' },
  { color: '#7B9B7B', name: 'Moss' },
  { color: '#8BA88B', name: 'Muted Sage' },
  { color: '#5B7B5B', name: 'Fern' },
  { color: '#4A6B4A', name: 'Hunter' },
  { color: '#90A878', name: 'Pistachio' },
  { color: '#6B8B5E', name: 'Olive' },
  { color: '#789B70', name: 'Eucalyptus' },
  // ── Teals & Cyans ──
  { color: '#06B6D4', name: 'Cyan' },
  { color: '#0891B2', name: 'Teal' },
  { color: '#0D9488', name: 'Jade' },
  { color: '#6B9E9E', name: 'Muted Teal' },
  { color: '#5B8E8E', name: 'Sea Glass' },
  { color: '#6BAA96', name: 'Seafoam' },
  { color: '#4A8B8B', name: 'Pacific' },
  { color: '#789B90', name: 'Celadon' },
  { color: '#8BA0A8', name: 'Pewter Blue' },
  // ── Earth Tones ──
  { color: '#8B7B68', name: 'Driftwood' },
  { color: '#7B6B58', name: 'Walnut' },
  { color: '#9B8B78', name: 'Sandstone' },
  { color: '#A89888', name: 'Mushroom' },
  { color: '#8B8068', name: 'Khaki' },
  { color: '#6B6050', name: 'Umber' },
  { color: '#9B9080', name: 'Taupe' },
  { color: '#B8A898', name: 'Linen' },
  // ── Cool Neutrals ──
  { color: '#6B7280', name: 'Gray' },
  { color: '#4B5563', name: 'Charcoal' },
  { color: '#374151', name: 'Graphite' },
  { color: '#7888A0', name: 'Storm' },
  { color: '#8B9098', name: 'Silver' },
  { color: '#9B918B', name: 'Warm Gray' },
  { color: '#707880', name: 'Gunmetal' },
  // ── Warm Neutrals ──
  { color: '#8B8078', name: 'Pebble' },
  { color: '#A09088', name: 'Ash Rose' },
  { color: '#988880', name: 'Mocha' },
  // ── Jewel Tones ──
  { color: '#4338CA', name: 'Cobalt' },
  { color: '#7E22CE', name: 'Byzantine' },
  { color: '#0E7490', name: 'Peacock' },
  { color: '#047857', name: 'Malachite' },
  { color: '#9F1239', name: 'Garnet' },
  { color: '#92400E', name: 'Amber' },
  { color: '#1E3A5F', name: 'Midnight' },
  { color: '#4A1942', name: 'Aubergine' },
  // ── Monochrome ──
  { color: '#000000', name: 'Black' },
  { color: '#18181B', name: 'Onyx' },
  { color: '#27272A', name: 'Obsidian' },
];
